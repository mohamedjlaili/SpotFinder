...
export interface ApiReservationReservation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    spaceName: Schema.Attribute.String;
    startDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
    status: Schema.Attribute.String & Schema.Attribute.DefaultTo<'confirmed'>;
...
export interface ApiSpaceSpace extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::space.space'> &
      Schema.Attribute.Private;
    managerId: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    profileImage: Schema.Attribute.Text;
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    roleType: Schema.Attribute.Enumeration<['admin', 'user', 'manager']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
